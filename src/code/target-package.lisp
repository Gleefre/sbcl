...
(defun !package-cold-init (&aux (specs (cdr *!initial-symbols*)))
  ...
  #+symbol-links (setf sb-ext:*follow-symbol-links* t)
  #+symbol-links (setf *symbol->symbol-link* (make-hash-table))
  #+symbol-links (setf *symbol->symbol-linked-by* (make-hash-table))

...
is a good idea, but see SB-SYS re. blurring of boundaries.")
  ...
  (:export "%%DATA-VECTOR-REFFERS%%"
           ...
           #+symbol-links "SYMBOL-LINK-ERROR"
           #+symbol-links "CYCLIC-SYMBOL-LINK"
           #+symbol-links "CONFLICTING-SYMBOL-LINK"
           #+symbol-links "%ADD-SYMBOL-LINK"
           #+symbol-links "%REMOVE-SYMBOL-LINK"
           #+symbol-links "%SYMBOL-LINK"
           #+symbol-links "%SYMBOL-LINKED-BY"
           #+symbol-links "*SYMBOL->SYMBOL-LINKED-BY*"
           #+symbol-links "*SYMBOL->SYMBOL-LINK*"
